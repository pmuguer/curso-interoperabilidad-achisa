...
class ADTMessage {
    ...
    def ADTMessage(patient, dateTimeOfMessage, messageControlID, locationMap, admitDateTime) {
        // Genera un nuevo mensaje ADT, para el paciente patient
        // patient:
        ...
        this.setPV1Data(admitDateTime, locationMap)
    }
